...
if ($djbm == 'zk') {
    $dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
     $sql = "INSERT INTO fa_ykjp_kl (id, kl_ddbh, kl_cnlh, kl_zptime, kl_zpsl, kl_scgs, kl_czname, kl_mrb, kl_bzcont, kl_status, kl_sysl, kl_bm)
     VALUES (id, '$ddbh', '$cnlh', '$time', '$zpsl', '$scgs', '$czname', '$mrb', '$bzcont', '$zpgx', '$sysl', '$bbm')";
     $dsql = "INSERT INTO fa_ykjp_zk (id, kl_ddbh, kl_cnlh, kl_zptime, kl_zpsl, kl_scgs, kl_czname, kl_mrb, kl_bzcont, kl_status, kl_sysl, kl_bm)
     VALUES (id, '$ddbh', '$cnlh', '$time', '$zpsl', '$scgs', '$czname', '$mrb', '$bzcont', '$zpgx', '$sysl', '$bbm')";
     $fsql = "UPDATE fa_ykjp_sclc SET lcxs=CONCAT('c',lcxs) WHERE scddbh=$ddbh";
