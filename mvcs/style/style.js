...
$(".end").click(function(event){
    var etjsy = $(this).parent().parent().parent(".main_list_li").children(".main_list_tj").children(".tckongzhi").children(".listlix").children(".tjsy:first").text();
    if (etjsy != "0") {
        alert('订单未完成，请先完成后再提交!');
    }else{
        event.stopPropagation(); 
